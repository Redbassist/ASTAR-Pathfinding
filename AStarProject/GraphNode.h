...
// -------------------------------------------------------
// Description: Heuristic value of the path
// -------------------------------------------------------
	int heuristicValue;

//location of the node, stored in X and Y
	int m_x;
	int m_y;

//state that holds the color of the nodes
	// 0 = BLUE, 1 = YELLOW, 2 = RED, 3 = HIGHLIGHTED
	int colour;

//store the previous node that accessed this node
...
public:
	...
	void setPrevious(GraphNode* node) {
		previousNode = node;
	}
	...
	void setPosition(std::pair<int, int> pos) {
		m_x = pos.first;
		m_y = pos.second;
		//nodeCircle.setPosition(m_x, m_y);
	}
